...
exports.getAllFlowMeters = async (req, res) => {
  try {
    ...
    // Inject today's consumption data
...
exports.getFlowMeterById = async (req, res) => {
  try {
...
exports.getFlowMeterHistory = async (req, res) => {
  try {
    const flowMeterId = req.params.id;
...
exports.getFlowMeterConsumption = async (req, res) => {
  try {
    const flowMeterId = req.params.id;
